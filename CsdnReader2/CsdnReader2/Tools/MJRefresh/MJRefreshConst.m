...
NSString *const MJRefreshFooterRefreshing = @"正在努力刷新中...";




NSString *const MJRefreshHeaderPullToRefresh = @"下拉可以刷新数据";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即刷新数据";
NSString *const MJRefreshHeaderRefreshing = @"正在努力加载数据中...";
